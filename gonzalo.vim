...
elseif &t_Co == 256
    ...
    hi SpecialKey     ctermbg=none  ctermfg=176   cterm=none
    ...
    " -> Tabs
	hi TabLine        ctermbg=240  ctermfg=252   cterm=none
    hi TabLineFill    ctermbg=235                cterm=none
	hi TabLineSel     ctermbg=240  ctermfg=117   cterm=bold 
    "
    " -> Visual Mode
    ...
    hi MatchParen     ctermbg=214   ctermfg=134   cterm=none
    hi PreProc        ctermbg=none  ctermfg=141   cterm=none
    hi Special        ctermbg=none  ctermfg=40    cterm=none
